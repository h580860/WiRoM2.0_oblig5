...
public class RobotgeneratorGenerator extends AbstractGenerator {
    ...
    for (final Command e : _filter) {
      {
        ...
        if (_equals) {
          ...
          if (_equals_1) {
            ...
            _builder_3.append("_simpleactions.py");
            fsa.generateFile(_builder_3.toString(), this.compile_mavic2pro(e));
          } else {
            boolean _equals_2 = e.getRobotType().equals(RobotType.OP2);
            if (_equals_2) {
              StringConcatenation _builder_4 = new StringConcatenation();
              _builder_4.append("robotgenerator/");
              String _value_8 = e.getRobotName().getValue();
              _builder_4.append(_value_8);
              _builder_4.append("/");
              String _value_9 = e.getRobotName().getValue();
              _builder_4.append(_value_9);
              _builder_4.append("_simpleactions.py");
              fsa.generateFile(_builder_4.toString(), this.compile_op2(e));
            } else {
              boolean _equals_3 = e.getRobotType().equals(RobotType.BB8);
              if (_equals_3) {
                StringConcatenation _builder_5 = new StringConcatenation();
                _builder_5.append("robotgenerator/");
                String _value_10 = e.getRobotName().getValue();
                _builder_5.append(_value_10);
                _builder_5.append("/");
                String _value_11 = e.getRobotName().getValue();
                _builder_5.append(_value_11);
                _builder_5.append("_simpleactions.py");
                fsa.generateFile(_builder_5.toString(), this.compile_bb8(e));
              }
            }
          }
        }
  ...
  public CharSequence compile_op2(final Command command) {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("\"\"\"op2_controller simpleactions.\"\"\"");
    _builder.newLine();
    _builder.append("\"\"\" Source: http://www.running-robot.net/en/notice-en/212.html \"\"\"");
    _builder.newLine();
    _builder.append("import math");
    _builder.newLine();
    _builder.append("import threading");
    ...
    _builder.append("import pika");
    _builder.newLine();
    _builder.append("from controller import Robot");
    _builder.newLine();
    _builder.append("# TODO fix the LEDS");
    _builder.newLine();
    _builder.append("# from controller import LED");
    _builder.newLine();
    _builder.append("import os");
    _builder.newLine();
    _builder.append("import sys");
    _builder.newLine();
    _builder.append("libraryPath = os.path.join(os.environ.get(\"WEBOTS_HOME\"), \'projects\', \'robots\', \'robotis\', \'darwin-op\', \'libraries\', \'python39\')");
    _builder.newLine();
    _builder.append("libraryPath = libraryPath.replace(\'/\', os.sep)");
    _builder.newLine();
    _builder.append("sys.path.append(libraryPath)");
    _builder.newLine();
    _builder.append("from managers import RobotisOp2MotionManager, RobotisOp2GaitManager");
    _builder.newLine();
    _builder.newLine();
    _builder.append("# create the Robot instance.");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("f_up = 0");
    _builder.newLine();
    _builder.append("f_down = 0");
    _builder.newLine();
    _builder.append("gyro = robot.getDevice(\'Gyro\')");
    _builder.newLine();
    _builder.append("gyro.enable(timestep)");
    _builder.newLine();
    _builder.append("x_amplitude_forward = 0.0");
    _builder.newLine();
    _builder.newLine();
    _builder.newLine();
    _builder.append("positionSensorNames = [\'ShoulderR\', \'ShoulderL\', \'ArmUpperR\', \'ArmUpperL\',");
    _builder.newLine();
    _builder.append("                                    ");
    _builder.append("\'ArmLowerR\', \'ArmLowerL\', \'PelvYR\', \'PelvYL\',");
    _builder.newLine();
    _builder.append("                                    ");
    _builder.append("\'PelvR\', \'PelvL\', \'LegUpperR\', \'LegUpperL\',");
    _builder.newLine();
    _builder.append("                                    ");
    _builder.append("\'LegLowerR\', \'LegLowerL\', \'AnkleR\', \'AnkleL\',");
    _builder.newLine();
    _builder.append("                                    ");
    _builder.append("\'FootR\', \'FootL\', \'Neck\', \'Head\']");
    _builder.newLine();
    _builder.newLine();
    _builder.append("positionSensors = []");
    _builder.newLine();
    _builder.append("for i in range(len(positionSensorNames)):");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("positionSensors.append(robot.getDevice(positionSensorNames[i] + \'S\'))");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("positionSensors[i].enable(timestep)");
    _builder.newLine();
    _builder.newLine();
    _builder.newLine();
    _builder.append("motion_manager = RobotisOp2MotionManager(robot)");
    _builder.newLine();
    _builder.append("gait_manager = RobotisOp2GaitManager(robot, \"\")");
    _builder.newLine();
    _builder.append("is_walking = False");
    _builder.newLine();
    _builder.newLine();
    _builder.append("target_reached = False");
    _builder.newLine();
    ...
    _builder.append("location = []");
    _builder.newLine();
    _builder.append("# simpleactions = [\"go_forward(3)\", \"turn_right(2)\", \"go_forward(2)\"]");
    _builder.newLine();
    _builder.append("simpleactions = []");
    _builder.newLine();
    _builder.newLine();
    _builder.append("op2_name = \"\"");
    _builder.newLine();
    _builder.newLine();
    _builder.append("# Initialize which sets the target altitude as well as start the main loop");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("global op2_name");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("op2_name = name");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("main = threading.Thread(target=op2_main)");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("communication = threading.Thread(target=test_receive_routing_message)");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("def my_step():");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("global robot,timestep");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("ret = robot.step(timestep)");
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("def wait(ms):");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("global robot");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("startTime = robot.getTime()");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("sec = ms / 1000");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("while sec + startTime >= robot.getTime():");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("my_step()");
    _builder.newLine();
    _builder.newLine();
    _builder.newLine();
    _builder.append("def go_forward(duration):");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("global x_amplitude_forward, op2_name");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("x_amplitude_forward = 1.0");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("if duration != 0:");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("print(f\"{op2_name} sleeping for {duration} seconds\")");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("time.sleep(duration)");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("def op2_main():");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("global x_amplitude_forward");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("step_count = 0");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("my_step()       # Simulate a step to refresh the sensor reading");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("motion_manager.playPage(9)");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("wait(200)");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    _builder.append("# Start the gait manager");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("gait_manager.start()");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("gait_manager.setBalanceEnable(True)");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    _builder.append("while robot.step(timestep) != -1:");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("gait_manager.setXAmplitude(x_amplitude_forward)");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("gait_manager.step(timestep)");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("step_count += 1");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("channel.queue_bind(exchange=\'routing_exchange\', queue=queue_name, routing_key=f\"{op2_name}_queue\")");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    _builder.append("print(f\"{op2_name} ready to receive routed messages\")");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("channel.basic_consume(queue=queue_name, on_message_callback=execute_simpleactions_callback, auto_ack=True)");
    _builder.newLine();
  ...
  public CharSequence compile_bb8(final Command command) {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("\"\"\"moose_controller simpleactions.\"\"\"");
    _builder.newLine();
    _builder.append("from controller import Robot, Motor, PositionSensor, GPS, Compass");
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("# initiate the motors");
    _builder.newLine();
    _builder.append("# keep track of the motors in a dictionary");
    _builder.newLine();
    _builder.append("motors = {}");
    _builder.newLine();
    _builder.append("motor_names = [\"body yaw motor\", \"body pitch motor\", \"head yaw motor\"]");
    _builder.newLine();
    _builder.append("for name in motor_names:");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("motors[name] = robot.getDevice(name)");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("motors[name].setPosition(float(\'inf\'))");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("motors[name].setVelocity(0.0)");
    _builder.newLine();
    _builder.newLine();
    _builder.append("yaw_speed = 0.0");
    _builder.newLine();
    _builder.append("pitch_speed = 0.0");
    _builder.newLine();
    _builder.append("max_speed = 4.0");
    _builder.newLine();
    _builder.append("attenuation = 0.9");
    _builder.newLine();
    _builder.newLine();
    _builder.append("target_reached = False");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("global bb8_name");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("logging.info(\"init\")");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("bb8_name = name");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("main = threading.Thread(target=bb8_main)");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("communication = threading.Thread(target=receive_routing_message)");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("main.start()");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("global pitch_speed, attenuation, bb8_name, max_speed");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("# pitch_speed += attenuation");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("pitch_speed = max_speed");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    _builder.append("if duration != 0:");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("print(f\"{bb8_name} sleeping for {duration} second(s)\")");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("time.sleep(duration)");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("global yaw_speed, max_speed");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("yaw_speed = max_speed");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    _builder.append("if duration != 0:");
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("def bb8_main():");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("global yaw_speed, pitch_speed, max_speed");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("step_count = 0");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("# pitch_speed = min(max_speed, max(-max_speed, attenuation * pitch_speed))");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("# yaw_speed = min(max_speed, max(-max_speed, attenuation * yaw_speed))");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("motors[\'body yaw motor\'].setVelocity(yaw_speed)");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("motors[\'head yaw motor\'].setVelocity(yaw_speed)");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("motors[\'body pitch motor\'].setVelocity(pitch_speed)");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("step_count += 1");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("def receive_routing_message():");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("global bb8_name");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("channel.queue_bind(exchange=\'routing_exchange\', queue=queue_name, routing_key=f\"{bb8_name}_queue\")");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    _builder.append("print(f\"{bb8_name} ready to receive routed messages\")");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("channel.basic_consume(queue=queue_name, on_message_callback=execute_simpleactions_callback, auto_ack=True)");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("global simpleactions, bb8_name");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("print(f\"{bb8_name} callback: %r\" % body)");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("# TODO as for now, the incoming messages are functions calls, separated by \",\"");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("print(f\'{bb8_name} Simpleactions = {simpleactions}, type={type(simpleactions)}\')");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    _builder.append("# Now execute the simpleactions");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("print(f\"{bb8_name} Executing simpleaction \" + sim_act)");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("eval(sim_act)");
    _builder.newLine();
