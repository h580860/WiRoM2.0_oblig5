...
channel.basic_publish(exchange='routing_exchange', routing_key='moose_queue', body=json.dumps(test_moose_message))
print("[send_routing_message] published to moose")

# publish the mavic message
channel.basic_publish(exchange='routing_exchange', routing_key='mavic2pro_queue', body=json.dumps(test_mavic_message))
